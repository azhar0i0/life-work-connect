    ...
    >
      <div className="container mx-auto px-6">
        <nav className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link
            to="/get-started"
            className="hidden md:inline-flex items-center gap-2 px-5 py-2.5 bg-primary text-primary-foreground font-medium text-sm rounded-lg transition-all duration-150 ease-human hover:bg-primary/90 press-effect focus-ring group"
          >
            Get Started
